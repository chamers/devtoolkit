            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16">
              <div className="flex-1 space-y-6 lg:space-y-7">
                <div className="space-y-4 lg:space-y-5">
                  ...
                  <h1>
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-sys-light-prim via-amber-400 to-amber-600">{title}</span></h1>
                ...
                <div className="flex flex-wrap gap-3 lg:gap-4">
                  ...
                  <Button variant="outline" className="flex items-center transition group">
                    <FiBookOpen className="group-hover:rotate-12 transition-transform duration-300 text-neutral-600 dark:text-neutral-400" />
                    <span className="font-mono tracking-widest text-neutral-600 dark:text-neutral-400">documentation</span>
                  </Button>
                </div>
                <div className="flex flex-col sm:flex-row gap-5 sm:items-center pt-6 lg:pt-7 border-t border-neutral-200 dark:border-neutral-800">
                  <div className="flex -space-x-3">
                    <Image src="https://randomuser.me/api/portraits/thumb/men/75.jpg" alt="User Avatar" width={36} height={36} className="w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-neutral-200 dark:border-neutral-900 object-cover" />
                    <Image src="https://randomuser.me/api/portraits/thumb/women/21.jpg" alt="User Avatar" width={36} height={36} className="w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-neutral-200 dark:border-neutral-900 object-cover" />
                    <Image src="https://randomuser.me/api/portraits/thumb/men/12.jpg" alt="User Avatar" width={36} height={36} className="w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-neutral-200 dark:border-neutral-900 object-cover" />
                    <span className="flex items-center justify-center w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-neutral-200 dark:border-neutral-900 object-cover text-xs font-medium bg-orange-sys-light-prim dark:bg-pink-sys-dark-prim text-white dark:text-neutral-900">+5K</span>
                  </div>
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <StarRating rating={rating} />
                  <p className="text-sm text-neutral-800 dark:text-neutral-400">({rating}/5)</p>
                    </div>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">Trusted by <span className="font-semibold text-neutral-900 dark:text-neutral-300">5,000+</span> developers worldwide</p>
                  </div>
                </div>
              </div>
            </div>
