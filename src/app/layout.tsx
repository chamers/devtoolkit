...
const crimsonPro = localFont({
  src: [
    { path: "./fonts/CrimsonPro-VariableFont_wght.ttf", style: "normal" }],
  display: "swap",
...
const robotoCondensed = localFont({
  src: [{ path: "./fonts/RobotoCondensed-VariableFont_wght.ttf", style: "normal" }],
  display: "swap",
  variable: "--font-condensed",
});

const GaramondItalic = localFont({
  src: [{ path: "./fonts/EBGaramond-Italic-VariableFont_wght.ttf", style: "italic" }],
  display: "swap",
...
export const metadata: Metadata = {
  ...
  description: "DevToolkit empowers developers of all levels to build web applications faster and easier. It provides a comprehensive suite of tools for front-end development, back-end development, digital design and code management.",
};
