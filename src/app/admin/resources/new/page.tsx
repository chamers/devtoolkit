  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="flex flex-col lg:flex-row gap-6 p-4">
        {/* Preview */}
        <aside className="order-1 lg:order-2 w-full lg:w-1/2 rounded-lg border p-4 overflow-y-auto">
        ...
        {/* Form */}
        <main className="order-2 lg:order-1 w-full lg:w-1/2 rounded-lg border p-4 overflow-y-auto">
